# gpt2_explainer.py
# GPT-2 based fraud explanation generator
# GPT-2 is used to convert model-based reasons into simple English.
# This makes the explanation more accurate and easier to defend.
